...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado de Categorias <a href="" data-target="#modal-nuevo" data-toggle="modal"><button class="btn btn-success">Nueva</button></a></h3>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				@include('almacen.categoria.mcreate')
				@endforeach
			</table>
		</div>
		{{$categorias->render()}}
